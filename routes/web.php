...
Route::post('sauvegarderFrais',[
        'as'=>'chemin_sauvegardeFrais', // trouver dans la vue sommaire 
        'uses'=>'gererFraisController@sauvegarderFrais' // aller dans le controler gérer frais et accèder à la méthode sauvegarde frais 
]);
